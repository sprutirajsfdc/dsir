...
import getPropertiesUk from '@salesforce/apex/LeadController.getPropertiesUk';
import getPicklistValues from '@salesforce/apex/LeadController.getPicklistValues';
import { NavigationMixin } from 'lightning/navigation';

export default class UkLeadPool extends LightningElement {
    @track typeOptions = [];
